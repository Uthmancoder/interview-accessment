  ...
  return (
    <div className="bg-black/5 md:min-h-screen flex items-center">
      <div className="w-full md:w-11/12  bg-white  lg:w-full max-w-[800px] mx-auto shadow-lg md:p-4 rounded-lg grid md:grid-cols-7">
        <div className="w-full md:w-11/12 bg-white  lg:w-8/12 mx-auto shadow-lg md:p-4 rounded-lg grid md:grid-cols-7">
          {/* Sidebar */}
              ...
              {steps.map((data, index) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center justify-start mx-3  mx-auto md:mx-0 gap-4 mt-6 cursor-pointer"
                  >
                    {/* Step Indicator */}
                    <div
